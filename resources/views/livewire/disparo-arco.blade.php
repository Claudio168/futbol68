    ...
    <div class="overflow-x-auto table-container">
        <table id="customers">
            ...
            <tbody>
                ...
                @php
                $sumaTiros = $partido->shots_on_goal + $partido->shots_on_goal2;
                $acum += $sumaTiros;
                $indice = $indice+1;
                $prom = $acum/$indice;
                @endphp
                <tr>
                    ...
                    <td>
                        <div>
                            ...
                            <p>{{$partido->shots_on_goal + $partido->shots_on_goal2}}</p>
                        </div>
                    </td>
                    <td>
                        @php

                        $suma = $partido->shots_on_goal + $partido->shots_on_goal2;
