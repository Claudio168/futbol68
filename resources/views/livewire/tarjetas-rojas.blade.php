<div class="bg-gray-900">
    <div class="overflow-x-auto">
        @if($countMaches > 30)
        <livewire:calculadora-tarjetas :pais="$pais" :temPorDefecto="$temPorDefecto" :liga="$liga" :temporada="$temporada" />
        @endif
        <div class="flex">
            ...
            <select  class="seleccion" wire:model.live="param" >
                ...
                <option value="tarjetas-arbitro">Arbitro</option>
        ...
        <table id="customers">
            ...
            <tfoot>
                <tr>
                    <td>Suma (Promedio)</td>
                    <td colspan="3"></td>
                    <td>{{$acumRojas}} ({{ number_format($promTRojas, 2) }})</td>
