    ...
    <div class="overflow-x-auto table-container">
        <table id="customers">
            ...
            <tbody>
                ...
                @php
                $sumaTiros = $partido->shots_outside_box + $partido->shots_outside_box2;
                $acum += $sumaTiros;
                $indice = $indice+1;
                $prom = $acum/$indice;
                @endphp
                <tr>
                    ...
                    <td>
                        <div>
                            ...
                            <p>{{$partido->shots_outside_box + $partido->shots_outside_box2}}</p>
                        </div>
                    </td>
                    <td>
                        @php

                        $suma = $partido->shots_outside_box + $partido->shots_outside_box2;
